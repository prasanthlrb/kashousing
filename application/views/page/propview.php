	...
	<div class="row margin-bottom-50">
		<div class="col-md-12">
			...
			<div class="property-slider default">
				<a href="<?php echo base_url();?>assets/property/images/single-property-01.jpg" data-background-image="<?php echo base_url();?>assets/property/images/single-property-01.jpg" class="item mfp-gallery"></a>
				<a href="<?php echo base_url();?>assets/property/images/single-property-02.jpg" data-background-image="<?php echo base_url();?>assets/property/images/single-property-02.jpg" class="item mfp-gallery"></a>
				<a href="<?php echo base_url();?>assets/property/images/single-property-03.jpg" data-background-image="<?php echo base_url();?>assets/property/images/single-property-03.jpg" class="item mfp-gallery"></a>
				<a href="<?php echo base_url();?>assets/property/images/single-property-04.jpg" data-background-image="<?php echo base_url();?>assets/property/images/single-property-04.jpg" class="item mfp-gallery"></a>
				<a href="<?php echo base_url();?>assets/property/images/single-property-05.jpg" data-background-image="<?php echo base_url();?>assets/property/images/single-property-05.jpg" class="item mfp-gallery"></a>
				<a href="<?php echo base_url();?>assets/property/images/single-property-06.jpg" data-background-image="<?php echo base_url();?>assets/property/images/single-property-06.jpg" class="item mfp-gallery"></a>
			</div>

			<!-- Slider Thumbs -->
			<div class="property-slider-nav">
				<div class="item"><img src="<?php echo base_url();?>assets/property/images/single-property-01.jpg" alt=""></div>
				<div class="item"><img src="<?php echo base_url();?>assets/property/images/single-property-02.jpg" alt=""></div>
				<div class="item"><img src="<?php echo base_url();?>assets/property/images/single-property-03.jpg" alt=""></div>
				<div class="item"><img src="<?php echo base_url();?>assets/property/images/single-property-04.jpg" alt=""></div>
				<div class="item"><img src="<?php echo base_url();?>assets/property/images/single-property-05.jpg" alt=""></div>
				<div class="item"><img src="<?php echo base_url();?>assets/property/images/single-property-06.jpg" alt=""></div>
			</div>
						...
						<div class="item">
							<div class="listing-item compact">
								...
								<a href="#" class="listing-img-container">
									...
									<img src="<?php echo base_url();?>assets/property/images/listing-01.jpg" alt="">
								</a>
