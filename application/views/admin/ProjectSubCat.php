  ...
  <div class="content-wrapper">
    ...
    <div class="box-body">
        <table id="table" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php $x=0; foreach ($subcat as $row) { $x++; ?>
            	<tr>
            		<td><?php echo $x; ?></td>
            		<td>
            			<?php
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <div class="col-md-12">
                    			...
                    			<select class="form-control" id="maincat" name="maincat">
                			...
                			<div class="col-md-12">
                    			...
                    			<input autocomplete="off" type="text" class="form-control" id="subcat" name="subcat" placeholder="Category">
                			</div>
                        </div>
...
function Edit(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Project/EditSubCat')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function Save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('Project/SaveSubCat')?>";
    } else {
        url = "<?php echo site_url('Project/UpdateSubCat')?>";
    }
...
function Delete(id)
{
    ...
    {
        $.ajax({
            url : "<?php echo site_url('Project/DeleteSubCat')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
