...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="<?php echo base_url(); ?>Open_image/fetch/<?php echo $row->id; ?>" >Upload Image</a></li>
    <?php } else{ ?>
        <li><a href="<?php echo base_url(); ?>Contact/ContactView/<?php echo $row->id; ?>" >View</a></li>
    <?php } ?>
    </ul>
</div>
                    </td>
...
function Edit(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Client/Edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function Delete(id)
{
    ...
    {
        $.ajax({
            url : "<?php echo site_url('Client/Delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
