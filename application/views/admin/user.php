<?php $this->load->view('admin/include/header');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
        ...
        <button class="btn btn-success" onclick="add_user()"><i class="glyphicon glyphicon-plus"></i> Create User</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('users/user_view')?>",
            "type": "POST"
        },
...
function add_user()
{
    ...
    $('.modal-title').text('Create User'); // Set Title to Bootstrap modal title
...
function user_edit(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('users/user_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
