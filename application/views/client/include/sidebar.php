    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="dashboard"><a href="<?php echo base_url();?>admin/dashboard">  <i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
         ...
         <<!-- li class="pages"><a href="<?php //echo base_url();?>page">  <i class="fa  fa-files-o"></i> <span>Page</span></a></li> -->
        <!--  <li class="property"><a href="<?php //echo base_url();?>property">  <i class="fa  fa-building"></i> <span>Property</span></a></li> -->
        ...
        <li class="users-st"><a href="<?php echo base_url();?>Project_image">  <i class="fa fa-users"></i> <span>Our Projects</span></a></li>
        <li class="users-st"><a href="<?php echo base_url();?>Facility">  <i class="fa fa-users"></i> <span>Our Facility</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <!-- <ul class="treeview-menu">
            <li><a href="<?php //echo base_url();?>"><i class="fa fa-circle-o"></i> Simple tables</a></li>
