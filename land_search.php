...
<div class="container">
	<div class="row sticky-wrapper">
		...
		<div class="col-md-8">
			...
			<!-- Main Search Input -->
			<form action="<?php echo base_url();?>Property/prop_land" method="post">
			<div class="main-search-input margin-bottom-35">
				<input name="city" type="text" class="ico-01" placeholder="Enter address e.g. street, city and state or zip" />
...
<?php if(!empty($files)): foreach ($search_val as $row) {?>
				<!-- Listing Item -->
				<div class="listing-item">

					<a href="<?php echo base_url();?>Property/single_land/<?php echo $row->id; ?>" class="listing-img-container">
                  ...
                  <span class="featured">Available</span>
						...
						<div class="listing-img-content">
							<span class="listing-price">₹<?php echo number_format($row->laexpectedprice)."<br>"; ?><i>₹<?php echo $row->lapriceper;?>  / sq ft</i></span>
                  ...
                  ?>
					...
					<div class="listing-content">
						...
						<div class="listing-title">
							<h4><a href="<?php echo base_url();?>Property/single_land/<?php echo $row->id; ?>"><?php echo $row->prop_named;?></a></h4>
							<a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom" class="listing-address popup-gmaps">
								<i class="fa fa-map-marker"></i>
								<div class="addre"><?php echo $row->regaddress; ?></div>
							</a>

							<a href="<?php echo base_url();?>Property/single_land/<?php echo $row->id; ?>" class="details button border">Details</a>
						</div>

						<ul class="listing-details">
							<li><?php echo $row->laplotarea;?> sq ft</li>
		...
		<div class="col-md-4">
			<div class="sidebar sticky right">
				...
				<div class="widget margin-bottom-40">
					<h3 class="margin-top-0 margin-bottom-35">Find New Land</h3>
...
<!-- 					<div class="range-slider">
						...
						<div id="area-range" data-min="0" data-max="170000" data-unit="sq ft"></div>
 ...
 -->
					...
					<button type="submit" class="button fullwidth margin-top-30" id="propert_search">Search</button>
...
<script>
	$('#propert_search').click(function(){
		//var data = $('#area-range').val();
		alert("data");
	});
</script>
