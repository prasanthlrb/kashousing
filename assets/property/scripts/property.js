...
for (var i = 1; i <= bedval; i++) {
             ...
             '<input required="true" class="form-control" name="length'+i+'" type="text" value=""/>'+
             ' </div>'+
             ' <div class="col-md-4">'+
             '<h5>(Breadth)</h5>'+
             '<input required="true" class="form-control" type="text" name="breadth'+i+'" value=""/>'+
             ' </div>'+
...
for (var i = 1; i < floorval; i++) {
    var ii=i+1;
              ...
              '<div class="submit-section">'+
                ...
                '<div class="col-md-4">'+
                '<h5>Bedrooms</h5>'+
                    '<select onchange="bedvaal()" class="chosen-select-no-single" name="bedrooms'+ii+'" id="'+ii+'">'+
